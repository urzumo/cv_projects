# РЕПОЗИТАРИЙ DATA SCIENCE ПРОЕКТОВ: DEEP LEARNING
...
| 03. SGD by torch ([github](https://github.com/urzumo/deep_learning_projects/tree/urzumo/scripts)) |SGD, torch, loss function|
